...
type ProviderVerifier interface {
	...
	VerifyIDTokenWithCache(ctx context.Context, idt []byte, cic *clientinstance.Claims, cachePath string) error
}
...
func (v *Verifier) VerifyPKTokenWithCachedKey(
	ctx context.Context,
	pkt *pktoken.PKToken,
	cachePath string,
	extraChecks ...Check,
	...
	if err := providerVerifier.VerifyIDTokenWithCache(ctx, pkt.OpToken, cic, cachePath); err != nil {
		return err
	}
